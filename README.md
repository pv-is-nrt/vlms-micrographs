...
_Prateek Verma_, _Minh-Hao Van_, _Xintao Wu_  
**Domain Expert**: _Prateek Verma_

Link to the paper:
[Beyond human vision: The role of large vision language models in microscope image analysis, IEEE BigData, 2024.](https://ieeexplore.ieee.org/stamp/stamp.jsp?arnumber=10825000)
...
> ## npj Computational Materials readers
>
> As of Oct 06, 2025, an updated and expanded version of the above IEEE BigData conference paper has been submitted for review to npj Computational Materials. Data specific to this submission is contained within the `npj_computational_materials` directory. The organization of this directory is similar to the root directory. Post publication, this README will be updated with a link to the published article.
